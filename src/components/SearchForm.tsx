    ...
    return (
        <form
            ...
            <div className="mt-10">
                ...
                {mutation.data && <p className="text-center text-cyan-500 font-black">{mutation.data}  <Link className="text-cyan-600" to={'/auth/register'} state={{handle: slugify(handle)}}>Ir a Registro</Link>  </p>}
